...
public class AnalysisService {
    ...
    // ─── Brand Colours ────────────────────────────────────────────────────────
    // Header gradient: dark purple → #800080
    private static final BaseColor COLOR_PURPLE_DARK = new BaseColor(60, 0, 60); // #3C003C header bg left
    private static final BaseColor COLOR_PURPLE = new BaseColor(128, 0, 128); // #800080 primary brand
    private static final BaseColor COLOR_PURPLE_PANEL = new BaseColor(40, 0, 40); // #280028 score panel bg
    private static final BaseColor COLOR_PURPLE_PALE = new BaseColor(248, 240, 255); // #F8F0FF section bg / cat cell
    private static final BaseColor COLOR_PURPLE_MID = new BaseColor(237, 224, 245); // #EDE0F5 border tint
    private static final BaseColor COLOR_PURPLE_LIGHT = new BaseColor(250, 240, 250); // summary bg
    ...
    private static final BaseColor COLOR_SUCCESS_BORDER = new BaseColor(168, 217, 188); // green border
    ...
    private static final BaseColor COLOR_WARNING_BORDER = new BaseColor(240, 208, 128); // amber border
    ...
    private static final BaseColor COLOR_DANGER_BORDER = new BaseColor(240, 176, 176); // red border

    private static final BaseColor COLOR_WHITE = BaseColor.WHITE;
    private static final BaseColor COLOR_BG = new BaseColor(250, 248, 250); // page bg tint
    private static final BaseColor COLOR_BORDER = new BaseColor(229, 231, 235); // #E5E7EB
    private static final BaseColor COLOR_BORDER_DASHED = new BaseColor(209, 213, 219); // dashed row separator
    ...
    private static final BaseColor COLOR_TEXT_FAINT = new BaseColor(156, 163, 175); // #9CA3AF labels
    private static final BaseColor COLOR_BAR_BG = new BaseColor(229, 231, 235); // progress track
    private static final BaseColor COLOR_AMBER_TEXT = new BaseColor(146, 64, 14); // pending badge text

    // ─── Fonts ────────────────────────────────────────────────────────────────
    // Header
    private static final Font F_REPORT_TAG = new Font(Font.FontFamily.HELVETICA, 8, Font.NORMAL,
            new BaseColor(200, 140, 200));
    private static final Font F_BRAND = new Font(Font.FontFamily.HELVETICA, 11, Font.BOLD,
            new BaseColor(232, 121, 249));
    private static final Font F_CAND_NAME = new Font(Font.FontFamily.HELVETICA, 22, Font.BOLD, BaseColor.WHITE);
    private static final Font F_META = new Font(Font.FontFamily.HELVETICA, 10, Font.NORMAL,
            new BaseColor(210, 170, 210));
    private static final Font F_SCORE_NUM = new Font(Font.FontFamily.HELVETICA, 34, Font.BOLD, BaseColor.WHITE);
    private static final Font F_SCORE_LBL = new Font(Font.FontFamily.HELVETICA, 9, Font.NORMAL,
            new BaseColor(210, 170, 210));
    private static final Font F_SCORE_HDR = new Font(Font.FontFamily.HELVETICA, 8, Font.NORMAL,
            new BaseColor(180, 130, 180));

    // Cards
    private static final Font F_CARD_TITLE = new Font(Font.FontFamily.HELVETICA, 9, Font.BOLD, COLOR_TEXT_FAINT);
    private static final Font F_LABEL = new Font(Font.FontFamily.HELVETICA, 9, Font.NORMAL, COLOR_TEXT_FAINT);
    private static final Font F_VALUE = new Font(Font.FontFamily.HELVETICA, 10, Font.BOLD, new BaseColor(55, 65, 81));
    private static final Font F_LINK = new Font(Font.FontFamily.HELVETICA, 10, Font.UNDERLINE, COLOR_PURPLE);
    private static final Font F_PENDING = new Font(Font.FontFamily.HELVETICA, 10, Font.BOLD, COLOR_AMBER_TEXT);
    ...
    // Skills
    private static final Font F_SKILL_NAME = new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD, COLOR_TEXT);
    private static final Font F_SKILL_LVL = new Font(Font.FontFamily.HELVETICA, 10, Font.ITALIC, COLOR_TEXT_MUTED);
    private static final Font F_SKILL_PCT_G = new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD, COLOR_SUCCESS);
    private static final Font F_SKILL_PCT_A = new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD, COLOR_WARNING);
    private static final Font F_SKILL_PCT_R = new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD, COLOR_DANGER);
    private static final Font F_SKILL_PCT_P = new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD, COLOR_PURPLE);
    ...
    private static final Font F_ICON_GRN = new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD, COLOR_SUCCESS);
    private static final Font F_ICON_RED = new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD, COLOR_DANGER);

    // Q&A
    private static final Font F_Q_TEXT = new Font(Font.FontFamily.HELVETICA, 11, Font.BOLD, new BaseColor(96, 0, 96));
    private static final Font F_Q_BODY = new Font(Font.FontFamily.HELVETICA, 10, Font.NORMAL, COLOR_TEXT);
    private static final Font F_Q_LBL = new Font(Font.FontFamily.HELVETICA, 9, Font.BOLD, COLOR_TEXT_FAINT);
    private static final Font F_Q_MISS_LBL = new Font(Font.FontFamily.HELVETICA, 9, Font.BOLD, COLOR_DANGER);
    private static final Font F_Q_INS_ITEM = new Font(Font.FontFamily.HELVETICA, 10, Font.NORMAL, COLOR_TEXT_MUTED);
    private static final Font F_Q_INS_ICON = new Font(Font.FontFamily.HELVETICA, 11, Font.BOLD, COLOR_SUCCESS);
    private static final Font F_Q_MISS_ICON = new Font(Font.FontFamily.HELVETICA, 11, Font.BOLD, COLOR_DANGER);

    // Category scores
    private static final Font F_CAT_LABEL = new Font(Font.FontFamily.HELVETICA, 8, Font.BOLD, COLOR_TEXT_FAINT);

    // Summary / Footer
    private static final Font F_SUMMARY = new Font(Font.FontFamily.HELVETICA, 10, Font.NORMAL,
        ...
        try {
            ...
            try {
                if (raw.startsWith("{")) {
                    ...
                    if (analysis == null)
                        throw new RuntimeException("'analysis' key not found");
                } else {
            ...
            // 1. Header banner
            addHeaderBanner(doc, candidateName, candidateEmail, candidatePhone, interviewDate, score);
            addSpacer(doc);

            // 2. Candidate + Session info cards (2-column) + Links card
            ...
            if (strengths.isArray() && strengths.size() > 0) {
                ...
                for (JsonNode s : strengths) {
                    ...
                    addBulletItem(doc, heading, desc, COLOR_SUCCESS, COLOR_SUCCESS_PALE,
                            COLOR_SUCCESS_BORDER, F_ICON_GRN, "\u2713  ");
                }
                addSpacer(doc);
            }
            ...
            if (improvements.isArray() && improvements.size() > 0) {
                addSectionHeader(doc, "Areas for Improvement / Weakness", COLOR_DANGER, F_SECTION_RED,
                        COLOR_DANGER_PALE, COLOR_DANGER_BORDER);
                for (JsonNode area : improvements)
                    addBulletItem(doc,
                            area.path("area").asText(""),
                            area.path("description").asText(""),
                            COLOR_DANGER, COLOR_DANGER_PALE, COLOR_DANGER_BORDER,
                            F_ICON_RED, "\u26A0  ");
                addSpacer(doc);
            }
            ...
            if (questions.isArray() && questions.size() > 0) {
                addSectionHeader(doc, "Interview Questions & Responses", COLOR_PURPLE, F_SECTION,
                        COLOR_PURPLE_PALE, COLOR_PURPLE_MID);
                for (JsonNode q : questions)
                    addQuestionBlock(doc, q);
                addSpacer(doc);
            }
    ...
    private void addHeaderBanner(Document doc,
            ...
            String date, String score) throws Exception {
        ...
        left.setPaddingTop(22);
        left.setPaddingBottom(22);
        ...
        // Email + phone + date meta row
        StringBuilder metaSb = new StringBuilder();
        if (email != null && !email.isEmpty())
            metaSb.append("\u2709  ").append(email);
        if (phone != null && !phone.isEmpty()) {
            if (metaSb.length() > 0)
                metaSb.append("     ");
            metaSb.append("\u260E  ").append(phone);
        }
        if (date != null && !date.isEmpty()) {
            if (metaSb.length() > 0)
                metaSb.append("     ");
            metaSb.append("\uD83D\uDCC5  ").append(date);
        }
        if (metaSb.length() > 0)
            left.addElement(new Paragraph(metaSb.toString(), F_META));

        banner.addCell(left);

        // ── Right cell: score box ─────────────────────────────────────────────
        ...
        Paragraph scoreHdr = new Paragraph("OVERALL SCORE", F_SCORE_HDR);
        scoreHdr.setAlignment(Element.ALIGN_CENTER);
        scoreHdr.setSpacingAfter(6);
    ...
    private void addInfoCards(Document doc,
        ...
        // ── Two-column: Candidate | Session ──────────────────────────────────
        PdfPTable grid = new PdfPTable(2);
        grid.setWidthPercentage(100);
        grid.setWidths(new float[] { 1f, 1f });
        grid.setSpacingBefore(4);

        PdfPCell leftCard = styledCard(COLOR_PURPLE);
        ...
        PdfPCell rightCard = styledCard(COLOR_PURPLE);
        ...
        statusRow.setSpacingBefore(6);
        statusRow.add(new Chunk("Status:   ", F_LABEL));
        statusRow.add(new Chunk("\u23F3  Pending Score", F_PENDING));
        ...
        PdfPCell linksCard = styledCard(COLOR_PURPLE);
    ...
    /** Card cell with coloured left border */
    private PdfPCell styledCard(BaseColor accentColor) {
    ...
    private void addCategoryScores(Document doc, JsonNode catScores) throws Exception {
        ...
        for (String pair : json.split(",")) {
            ...
            if (kv.length == 2) {
                ...
                try {
                    vals.add(Integer.parseInt(kv[1].trim().replace("\"", "")));
        ...
        for (int i = 0; i < keys.size(); i++) {
            ...
            cell.setBorderWidth(0.5f);
            // top accent line per score color
            cell.setBorderWidthTop(3f);
            cell.setBorderColorTop(scoreCol);
            cell.setPadding(12);
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);

            Font catFont = new Font(Font.FontFamily.HELVETICA, 22, Font.BOLD, scoreCol);
            Paragraph scoreP = new Paragraph(String.valueOf(pct), catFont);
            scoreP.setAlignment(Element.ALIGN_CENTER);
            scoreP.setSpacingAfter(2);
    ...
    private void addSectionHeader(Document doc, String text,
            BaseColor accentColor, Font font,
            BaseColor bgColor, BaseColor borderColor) throws Exception {

        PdfPTable hdr = new PdfPTable(1);
        hdr.setWidthPercentage(100);
        hdr.setSpacingBefore(16);
    ...
    private void addSkillRow(Document doc, JsonNode skill, BaseColor accentColor) throws Exception {
        ...
        cell.setPaddingLeft(13);
        cell.setPaddingRight(13);

        // Top row: name | level | pct
        PdfPTable topRow = new PdfPTable(3);
        topRow.setWidths(new float[] { 4f, 1.6f, 1.1f });
        ...
        // pct font matches accent color
        Font pctFont = skillPctFont(pct, accentColor);
        PdfPCell pctCell = new PdfPCell(new Phrase(pct + "/100", pctFont));
    ...
    /**
     * Pick pct-label font: purple for React-level (>=80 with purple accent), else
     * color by range
     */
    private Font skillPctFont(int pct, BaseColor accent) {
        if (accent.equals(COLOR_PURPLE))
            return F_SKILL_PCT_P;
        if (pct >= 70)
            return F_SKILL_PCT_G;
        if (pct >= 40)
            return F_SKILL_PCT_A;
        return F_SKILL_PCT_R;
    }

    // =========================================================================
    // SECTION: EMPTY STATE (for missing optional data)
    // =========================================================================

    private void addEmptyState(Document doc, String message,
            BaseColor bgColor, BaseColor borderColor) throws Exception {
        ...
        Paragraph p = new Paragraph(message, F_BODY);
    ...
    private void addBulletItem(Document doc, String heading, String body,
            BaseColor borderColor, BaseColor bgColor, BaseColor bottomBorderColor,
            Font iconFont, String icon) throws Exception {
        ...
        if (body != null && !body.isBlank()) {
            ...
            bodyPara.setIndentationLeft(18);
            bodyPara.setSpacingBefore(4);
    ...
    private void addQuestionBlock(Document doc, JsonNode q) throws Exception {
        ...
        BaseColor scoreCol = score >= 70 ? COLOR_SUCCESS
                : score >= 40 ? COLOR_WARNING
                        : COLOR_DANGER;
        BaseColor scoreBg = score >= 70 ? COLOR_SUCCESS_PALE
                : score >= 40 ? COLOR_WARNING_PALE
                        : COLOR_DANGER_PALE;

        PdfPTable card = new PdfPTable(1);
        card.setWidthPercentage(100);
        card.setSpacingBefore(7);
        ...
        scoreCell.setPaddingLeft(7);
        scoreCell.setPaddingRight(7);
        scoreCell.setPaddingTop(4);
        scoreCell.setPaddingBottom(4);
        ...
        if (insights.isArray() && insights.size() > 0) {
            ...
            insLbl.setSpacingBefore(10);
            insLbl.setSpacingAfter(3);
            cell.addElement(insLbl);
            for (JsonNode insight : insights) {
                Paragraph ins = new Paragraph();
                ins.setSpacingBefore(3);
                ins.add(new Chunk("\u203A  ", F_Q_INS_ICON));
                ins.add(new Chunk(insight.asText(), F_Q_INS_ITEM));
                cell.addElement(ins);
            }
        }
        ...
        if (missed.isArray() && missed.size() > 0) {
            ...
            missLbl.setSpacingBefore(10);
            missLbl.setSpacingAfter(3);
            cell.addElement(missLbl);
            for (JsonNode m : missed) {
                Paragraph mp = new Paragraph();
                mp.setSpacingBefore(3);
                mp.add(new Chunk("\u00D7  ", F_Q_MISS_ICON));
                mp.add(new Chunk(m.asText(), F_Q_INS_ITEM));
                cell.addElement(mp);
            }
        }
    ...
    private void addSummaryBox(Document doc, String summaryText) throws Exception {
        ...
        PdfPCell cell = new PdfPCell();
        cell.setBackgroundColor(COLOR_PURPLE_LIGHT);
        cell.setBorderColor(COLOR_PURPLE_MID);
        cell.setBorderWidth(0.5f);
        cell.setBorderWidthLeft(4f);
        cell.setBorderColorLeft(COLOR_PURPLE);
        ...
        Paragraph p = new Paragraph(summaryText, F_SUMMARY);
        p.setLeading(18f);
        cell.addElement(p);
...
// // ─── Brand Colours ────────────────────────────────────────────────────────
// private static final BaseColor COLOR_PURPLE_DARK = new BaseColor(60, 0, 60);
// // #3C003C header bg
// private static final BaseColor COLOR_PURPLE = new BaseColor(128, 0, 128); //
// #800080 primary
// private static final BaseColor COLOR_PURPLE_PANEL = new BaseColor(40, 0, 40);
// // score panel
// private static final BaseColor COLOR_PURPLE_PALE = new BaseColor(248, 240,
// 255); // #F8F0FF section bg
// private static final BaseColor COLOR_PURPLE_MID = new BaseColor(237, 224,
// 245); // #EDE0F5 border tint

// private static final BaseColor COLOR_SUCCESS = new BaseColor(22, 163, 74); //
// #16A34A
// private static final BaseColor COLOR_SUCCESS_PALE = new BaseColor(240, 253,
// 244); // #F0FDF4
// private static final BaseColor COLOR_WARNING = new BaseColor(202, 138, 4); //
// #CA8A04
// private static final BaseColor COLOR_WARNING_PALE = new BaseColor(255, 251,
// 235); // #FFFBEB
// private static final BaseColor COLOR_DANGER = new BaseColor(220, 38, 38); //
// #DC2626
// private static final BaseColor COLOR_DANGER_PALE = new BaseColor(255, 241,
// 242); // #FFF1F2

// private static final BaseColor COLOR_WHITE = BaseColor.WHITE;
// private static final BaseColor COLOR_BG = new BaseColor(250, 250, 250); //
// #FAFAFA
// private static final BaseColor COLOR_BORDER = new BaseColor(229, 231, 235);
// // #E5E7EB
// private static final BaseColor COLOR_TEXT = new BaseColor(17, 24, 39); //
// #111827
// private static final BaseColor COLOR_TEXT_MUTED = new BaseColor(107, 114,
// 128); // #6B7280
// private static final BaseColor COLOR_BAR_BG = new BaseColor(229, 231, 235);
// // track

// // ─── Fonts ────────────────────────────────────────────────────────────────
// // Header area
// private static final Font F_REPORT_TAG = new Font(Font.FontFamily.HELVETICA,
// 8, Font.NORMAL,
// new BaseColor(200, 160, 200));
// private static final Font F_BRAND = new Font(Font.FontFamily.HELVETICA, 10,
// Font.BOLD,
// new BaseColor(232, 121, 249));
// private static final Font F_CAND_NAME = new Font(Font.FontFamily.HELVETICA,
// 20, Font.BOLD, BaseColor.WHITE);
// private static final Font F_META = new Font(Font.FontFamily.HELVETICA, 10,
// Font.NORMAL,
// new BaseColor(220, 180, 220));
// private static final Font F_SCORE_NUM = new Font(Font.FontFamily.HELVETICA,
// 30, Font.BOLD, BaseColor.WHITE);
// private static final Font F_SCORE_LBL = new Font(Font.FontFamily.HELVETICA,
// 9, Font.NORMAL,
// new BaseColor(220, 180, 220));
// private static final Font F_SCORE_HDR = new Font(Font.FontFamily.HELVETICA,
// 8, Font.NORMAL,
// new BaseColor(180, 140, 180));

// // Candidate card
// private static final Font F_CARD_TITLE = new Font(Font.FontFamily.HELVETICA,
// 9, Font.BOLD, COLOR_TEXT_MUTED);
// private static final Font F_LABEL = new Font(Font.FontFamily.HELVETICA, 9,
// Font.BOLD, COLOR_TEXT_MUTED);
// private static final Font F_VALUE = new Font(Font.FontFamily.HELVETICA, 10,
// Font.NORMAL, COLOR_TEXT);
// private static final Font F_LINK = new Font(Font.FontFamily.HELVETICA, 10,
// Font.UNDERLINE, COLOR_PURPLE);
// private static final Font F_BADGE_AMBER = new Font(Font.FontFamily.HELVETICA,
// 9, Font.BOLD,
// new BaseColor(146, 64, 14));

// // Section & body
// private static final Font F_SECTION = new Font(Font.FontFamily.HELVETICA, 12,
// Font.BOLD, COLOR_PURPLE);
// private static final Font F_SECTION_GRN = new Font(Font.FontFamily.HELVETICA,
// 12, Font.BOLD, COLOR_SUCCESS);
// private static final Font F_SECTION_AMB = new Font(Font.FontFamily.HELVETICA,
// 12, Font.BOLD, COLOR_WARNING);
// private static final Font F_SECTION_RED = new Font(Font.FontFamily.HELVETICA,
// 12, Font.BOLD, COLOR_DANGER);

// private static final Font F_SKILL_NAME = new Font(Font.FontFamily.HELVETICA,
// 11, Font.BOLD, COLOR_TEXT);
// private static final Font F_SKILL_LVL = new Font(Font.FontFamily.HELVETICA,
// 9, Font.ITALIC, COLOR_TEXT_MUTED);
// private static final Font F_SKILL_PCT = new Font(Font.FontFamily.HELVETICA,
// 11, Font.BOLD, COLOR_PURPLE);
// private static final Font F_BODY = new Font(Font.FontFamily.HELVETICA, 10,
// Font.NORMAL, COLOR_TEXT_MUTED);

// private static final Font F_BULLET_HEAD = new Font(Font.FontFamily.HELVETICA,
// 11, Font.BOLD, COLOR_TEXT);
// private static final Font F_Q_TEXT = new Font(Font.FontFamily.HELVETICA, 11,
// Font.BOLD, COLOR_PURPLE);
// private static final Font F_Q_BODY = new Font(Font.FontFamily.HELVETICA, 10,
// Font.NORMAL, COLOR_TEXT);
// private static final Font F_Q_LBL = new Font(Font.FontFamily.HELVETICA, 9,
// Font.BOLD, COLOR_TEXT_MUTED);
// private static final Font F_Q_MISS_LBL = new Font(Font.FontFamily.HELVETICA,
// 9, Font.BOLD, COLOR_DANGER);

// private static final Font F_CAT_SCORE = new Font(Font.FontFamily.HELVETICA,
// 20, Font.BOLD, COLOR_TEXT); // color set
// // per cell
// private static final Font F_CAT_LABEL = new Font(Font.FontFamily.HELVETICA,
// 8, Font.BOLD, COLOR_TEXT_MUTED);

// private static final Font F_FOOTER_BRAND = new
// Font(Font.FontFamily.HELVETICA, 10, Font.BOLD, COLOR_PURPLE);
// private static final Font F_FOOTER_SUB = new Font(Font.FontFamily.HELVETICA,
// 9, Font.NORMAL, COLOR_TEXT_MUTED);
...
// @Transactional
// public void saveAnalysis(AnalysisRequestDto request) {
// InterviewLinkEntity interviewLink =
// interviewLinkRepository.findByToken(request.getToken())
// .orElseThrow(() -> new RuntimeException("Invalid token"));
...
// JsonNode questions = analysis.path("interview_questions_responses");
// if (questions.isArray() && questions.size() > 0) {
// addSectionHeader(doc, "Interview Questions & Responses", COLOR_PURPLE,
// F_SECTION);
// for (JsonNode q : questions)
// addQuestionBlock(doc, q);
// addSpacer(doc);
...
// private void addCategoryScores(Document doc, JsonNode catScores) throws
// Exception {
// addSectionHeader(doc, "Category Scores", COLOR_PURPLE, F_SECTION);
...
// Paragraph labelP = new Paragraph(toTitleCase(keys.get(i).replace("_", " ")),
// F_CAT_LABEL);
// labelP.setAlignment(Element.ALIGN_CENTER);
...
// private void addSkillRow(Document doc, JsonNode skill, BaseColor accentColor)
// throws Exception {
// String skillName = skill.path("skill_name").asText("N/A");
// String desc = skill.path("description").asText("");
// int pct = skill.path("percentage").asInt(0);
...
// Font scoreBadgeFont = new Font(Font.FontFamily.HELVETICA, 9, Font.BOLD,
// scoreCol);
...
// if (link.startsWith("http"))
// return link;
// String base = baseUrl.endsWith("/") ? baseUrl.substring(0, baseUrl.length() -
// 1) : baseUrl;
// return base + (link.startsWith("/") ? "" : "/") + link;
// }
...
// private static final BaseColor COLOR_PRIMARY = new BaseColor(128, 0, 128); //
// #800080 purple
// private static final BaseColor COLOR_PRIMARY_DARK = new BaseColor(96, 0, 96);
// // darker purple for right panel
// private static final BaseColor COLOR_SUCCESS = new BaseColor(22, 163, 74); //
// #16A34A green
// private static final BaseColor COLOR_WARNING = new BaseColor(202, 138, 4); //
// #CA8A04 amber
// private static final BaseColor COLOR_DANGER = new BaseColor(220, 38, 38); //
// #DC2626 red
// private static final BaseColor COLOR_BG_LIGHT = new BaseColor(252, 252, 255);
// // near-white with a hint of purple
// private static final BaseColor COLOR_BORDER = new BaseColor(229, 231, 235);
// // #E5E7EB neutral gray
// private static final BaseColor COLOR_TEXT_DARK = new BaseColor(17, 24, 39);
// // #111827
// private static final BaseColor COLOR_TEXT_MUTED = new BaseColor(107, 114,
// 128); // #6B7280
// private static final BaseColor COLOR_SECTION_BG = new BaseColor(250, 245,
// 255); // very light purple tint
// private static final BaseColor COLOR_BAR_BG = new BaseColor(229, 231, 235);
// // progress-bar track
// private static final BaseColor COLOR_STRENGTH_BG = new BaseColor(240, 253,
// 244); // light green bg
// private static final BaseColor COLOR_DANGER_BG = new BaseColor(255, 241,
// 242); // light red bg

// // ─── Fonts ───────────────────────────────────────────────────────────────
// private static final Font FONT_TITLE = new Font(Font.FontFamily.HELVETICA,
// 20, Font.BOLD, BaseColor.WHITE);
// private static final Font FONT_SUBTITLE = new Font(Font.FontFamily.HELVETICA,
// 12, Font.NORMAL, new BaseColor(220, 180, 220));
// private static final Font FONT_NAME = new Font(Font.FontFamily.HELVETICA, 18,
// Font.BOLD, BaseColor.WHITE);
// private static final Font FONT_LABEL = new Font(Font.FontFamily.HELVETICA,
// 10, Font.BOLD, COLOR_TEXT_MUTED);
// private static final Font FONT_VALUE = new Font(Font.FontFamily.HELVETICA,
// 12, Font.NORMAL, COLOR_TEXT_DARK);
// private static final Font FONT_SKILL_NAME = new
// Font(Font.FontFamily.HELVETICA, 12, Font.BOLD, COLOR_TEXT_DARK);
// private static final Font FONT_SKILL_LVL = new
// Font(Font.FontFamily.HELVETICA, 11, Font.ITALIC, COLOR_TEXT_MUTED);
// private static final Font FONT_SKILL_PCT = new
// Font(Font.FontFamily.HELVETICA, 12, Font.BOLD, COLOR_PRIMARY);
// private static final Font FONT_BODY = new Font(Font.FontFamily.HELVETICA, 11,
// Font.NORMAL, COLOR_TEXT_MUTED);
// private static final Font FONT_BULLET = new Font(Font.FontFamily.HELVETICA,
// 12, Font.BOLD, COLOR_TEXT_DARK);
// private static final Font FONT_SCORE_NUM = new
// Font(Font.FontFamily.HELVETICA, 32, Font.BOLD, BaseColor.WHITE);
// private static final Font FONT_SCORE_LBL = new
// Font(Font.FontFamily.HELVETICA, 12, Font.NORMAL, new BaseColor(220, 180,
// 220));
// private static final Font FONT_Q = new Font(Font.FontFamily.HELVETICA, 12,
// Font.BOLD, COLOR_PRIMARY);
// private static final Font FONT_Q_BODY = new Font(Font.FontFamily.HELVETICA,
// 11, Font.NORMAL, COLOR_TEXT_DARK);
// private static final Font FONT_LINK = new Font(Font.FontFamily.HELVETICA, 11,
// Font.UNDERLINE, COLOR_PRIMARY);
...
// // 2. Find existing record (if saveDuration or a previous saveAnalysis ran
// first)
// AnalysisEntity existingAnalysis = analysisRepository
// .findTopByInterviewLinkIdOrderByCreatedAtDesc(interviewLink.getId())
// .orElse(null);
...
// analysisRepository.save(existingAnalysis);
// } else {
// // INSERT: Create a stub record with empty JSON to satisfy the non-null
// constraint
// AnalysisEntity newAnalysis = AnalysisEntity.builder()
// .interviewLinkId(interviewLink.getId())
...
// String formattedVideoLink = (videoLink != null && !videoLink.isBlank() &&
// !videoLink.startsWith("http"))
// ? (baseUrl.endsWith("/") ? baseUrl.substring(0, baseUrl.length() - 1) :
// baseUrl) + (videoLink.startsWith("/") ? "" : "/") + videoLink
// : videoLink;
// String formattedTranscriptionLink = (transcriptionLink != null &&
// !transcriptionLink.isBlank() && !transcriptionLink.startsWith("http"))
// ? (baseUrl.endsWith("/") ? baseUrl.substring(0, baseUrl.length() - 1) :
// baseUrl) + (transcriptionLink.startsWith("/") ? "" : "/") + transcriptionLink
// : transcriptionLink;

// // 2. Candidate info card (vertical list)
// addCandidateInfoCard(doc, candidateName, candidateEmail, candidatePhone,
// interviewDate, interviewDuration, interviewLink, formattedVideoLink,
// formattedTranscriptionLink);
...
// * name, email, phone, date, duration, interviewLink, videoLink,
// transcriptionLink
// */
...
// Paragraph labelP = new Paragraph(toTitleCase(key.replace("_", " ")),
// FONT_LABEL);
// labelP.setAlignment(Element.ALIGN_CENTER);
// labelP.setSpacingBefore(4);
// cell.addElement(labelP);
...
// private void addSectionHeader(Document doc, String text, BaseColor color)
// throws Exception {
